...
namespace CourseManagement.Data
{
    public class SqlServerDataProvider<T> : IDisposable, ISqlServerDataProvider<T>
    {
        ...
        public (IList<T> result, int total, int totalDisplay) GetDat(string procedureName, IList<(string key, object value, bool isOut)> parameters)
        {
            ...
            int totalDisplay = (int)command.Parameters["TotalDisplay"].Value;
